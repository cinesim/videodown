...
<div align="center">
  ...
  <a href="https://github.com/cinesim/videodown/releases/latest">
    <img src="https://img.shields.io/github/downloads/videodown/videodown/latest/total.svg" alt="latest download">
  </a>
  <!-- sponsors -->
...
- বিভিন্ন [theme](https://github.com/cinesim/videodown/blob/main/docs/end-user/THEMES.md): **Cadmium Light**, **Material Dark** ইত্যাদি।
...
| :-----------------------------------------------------------------------------------------------------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------: |
| [![Download for macOS](https://img.shields.io/badge/macOS-Download-blue)](https://github.com/cinesim/videodown/releases/latest) | [![Download for Windows](https://img.shields.io/badge/Windows-Download-blue)](https://github.com/cinesim/videodown/releases/latest) | [![Download for Linux](https://img.shields.io/badge/Linux-Download-blue)](https://github.com/cinesim/videodown/releases/latest) |

সর্বশেষ সংস্করণের নতুন ফিচারগুলো দেখতে [CHANGELOG](https://github.com/cinesim/videodown/blob/main/docs/CHANGELOG.md) দেখুন।
...
আপনি [release page](https://github.com/cinesim/videodown/releases/latest) থেকে সর্বশেষ `videodown-mac-(arm64|x64)-%version%.dmg` ডাউনলোড করতে পারেন, অথবা [**homebrew cask**](https://github.com/caskroom/homebrew-cask) ব্যবহার করে videodown ইনস্টল করতে পারেন। Homebrew-Cask ব্যবহার করতে হলে আগে [Homebrew](https://brew.sh/) ইনস্টল করা থাকতে হবে।
...
শুধু setup wizard (`videodown-win-(x64|arm64)-%version%-setup.exe`) ডাউনলোড করে ইনস্টল করুন এবং user-only নাকি machine-wide ইনস্টল করবেন তা বেছে নিন। বিকল্পভাবে, [Chocolatey](https://chocolatey.org/) বা [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/) এর মতো package manager ব্যবহার করেও videodown ইনস্টল করতে পারেন।
...
অনুগ্রহ করে [Linux installation instructions](https://github.com/cinesim/videodown/blob/main/docs/end-user/INSTALLATION.md) অনুসরণ করুন।

#### অন্যান্য

Linux, macOS এবং Windows-এর সব binary [release page](https://github.com/cinesim/videodown/releases/latest) থেকে ডাউনলোড করা যাবে। আপনার সিস্টেমের জন্য কোনো সংস্করণ না থাকলে একটি [issue](https://github.com/cinesim/videodown/issues) খুলুন।

## ডেভেলপমেন্ট

আপনি যদি নিজে videodown build করতে চান, তাহলে আমাদের [build instructions](https://github.com/cinesim/videodown/blob/main/docs/dev/BUILD.md) দেখুন।

- [ব্যবহারকারী ডকুমেন্টেশন](https://github.com/cinesim/videodown/blob/main/docs/end-user/BASICS.md)
- [ডেভেলপার ডকুমেন্টেশন](https://github.com/cinesim/videodown/blob/main/docs/dev/README.md)

videodown সম্পর্কে আপনার কোনো প্রশ্ন থাকলে issue খুলতে পারেন। Issue খোলার সময় অনুগ্রহ করে ডিফল্ট ফরম্যাটটি ব্যবহার করুন। অবশ্যই, সরাসরি PR পাঠালে সেটিও অত্যন্ত প্রশংসিত হবে।

## অবদান

videodown এখনো উন্নয়নাধীন, তাই pull request করার আগে [Contributing Guide](../../.github/CONTRIBUTING.md) পড়ে নিন। videodown-এ নতুন ফিচার যোগ করতে চান? আমাদের [roadmap](https://github.com/cinesim/videodown/projects) এবং open issue দেখুন।

## অবদানকারীরা

যারা ইতিমধ্যেই videodown-এ অবদান রেখেছেন, তাদের সবাইকে ধন্যবাদ [[contributors](https://github.com/cinesim/videodown/graphs/contributors)]।
