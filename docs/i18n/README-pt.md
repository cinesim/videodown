...
Você pode baixar o último `videodown-%version%.dmg` da [página de releases](https://github.com/cinesim/videodown/releases/latest) ou instalar o videodown usando o [**homebrew cask**](https://github.com/caskroom/homebrew-cask). Para usar o Homebrew-Cask você só precisa ter o [Homebrew](https://brew.sh/) instalado.
...
Simplesmente baixe e instale o videodown via assistente de configuração (`videodown-setup-%version%.exe`) e escolha instalar por usuário ou para toda a máquina. Alternativamente, instale o videodown usando um gerenciador de pacotes como [Chocolatey](https://chocolatey.org/) ou [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/).
...
Todos os binários para Linux, macOS e Windows podem ser baixados da [página de releases](https://github.com/cinesim/videodown/releases/latest). Se uma versão não estiver disponível para o seu sistema, por favor abra um [issue](https://github.com/cinesim/videodown/issues).

## Desenvolvimento

Se você deseja compilar o videodown, por favor consulte nossas [instruções de compilação](../dev/BUILD.md).

- [Documentação do usuário](../README.md)
- [Documentação do desenvolvedor](../dev/README.md)

Se você tiver alguma dúvida sobre o videodown, fique à vontade para abrir um issue. Ao fazê-lo, use o formato padrão encontrado ao abrir um issue. Claro, se você enviar um PR diretamente, será muito apreciado.

## Contribuição

videodown está em desenvolvimento. Por favor leia o [Guia de Contribuição](../../.github/CONTRIBUTING.md) antes de fazer um pull request. Quer adicionar recursos ao videodown? Consulte nosso [roadmap](https://github.com/cinesim/videodown/projects) e issues abertas.

## Colaboradores

Obrigado a todas as pessoas que já contribuíram para o videodown[[colaboradores](https://github.com/cinesim/videodown/graphs/contributors)].
