...
[Sürümler sayfasından](https://github.com/cinesim/videodown/releases/latest) en son `videodown-%version%.dmg`'yi indirebilir veya [**homebrew cask**](https://github.com/caskroom/homebrew-cask) kullanarak videodown'i kurabilirsiniz. Homebrew-Cask kullanmak için [Homebrew](https://brew.sh/)'ün yüklü olması gerekir.
...
videodown'i kurulum sihirbazı (`videodown-setup-%version%.exe`) aracılığıyla indirip kurun ve kullanıcı başına mı yoksa sistem genelinde mi kurulacağını seçin. Alternatif olarak [Chocolatey](https://chocolatey.org/) veya [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/) gibi bir paket yöneticisi kullanabilirsiniz.
...
Linux, macOS ve Windows için tüm ikili dosyalar [sürümler sayfasından](https://github.com/cinesim/videodown/releases/latest) indirilebilir. Sisteminiz için bir sürüm mevcut değilse lütfen bir [issue](https://github.com/cinesim/videodown/issues) açın.

## Geliştirme

videodown'i kendiniz derlemek istiyorsanız lütfen [derleme talimatlarımıza](../dev/BUILD.md) bakın.

- [Kullanıcı belgeleri](../README.md)
- [Geliştirici belgeleri](../dev/README.md)

videodown hakkında sorularınız varsa bir issue yazabilirsiniz. Bunu yaparken issue açarken görünen varsayılan formatı kullanın. Elbette doğrudan bir PR gönderirseniz çok memnun oluruz.

## Katkı

videodown geliştirme aşamasındadır. Bir pull request oluşturmadan önce [Katkı Kılavuzunu](../../.github/CONTRIBUTING.md) okuduğunuzdan emin olun. videodown'e özellik eklemek ister misiniz? [Yol haritamıza](https://github.com/cinesim/videodown/projects) ve açık issue'lara bakın.

## Katkıda Bulunanlar

videodown'e zaten katkıda bulunan herkese teşekkür ederiz[[katkıda bulunanlar](https://github.com/cinesim/videodown/graphs/contributors)].
