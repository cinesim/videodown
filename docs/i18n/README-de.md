...
<h2 align="center">videodown unterstützen</h2>

videodown ist ein Open-Source-Markdown-Editor, der von seiner Community unterstützt wird. Wenn videodown Ihren Workflow verbessert, erwägen Sie bitte, [das Projekt zu sponsern](https://github.com/sponsors/videodown). Vielen Dank an alle Sponsoren ❤️

**Besonderer Sponsor**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=videodown) | [Extrahieren Sie Daten von Google und anderen Suchmaschinen über unsere schnelle, einfache und vollständige API.](https://serpapi.com/?utm_source=videodown) |
| --------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
Du kannst entweder die neueste `videodown-%version%.dmg` von der [Release-Seite](https://github.com/cinesim/videodown/releases/latest) herunterladen oder videodown über [**homebrew cask**](https://github.com/caskroom/homebrew-cask) installieren. Für Homebrew-Cask muss [Homebrew](https://brew.sh/) installiert sein.
...
Lade videodown einfach über den Setup-Assistenten (`videodown-setup-%version%.exe`) herunter und installiere es, wähle dabei zwischen Benutzer- oder systemweiter Installation. Alternativ kann videodown über einen Paketmanager wie [Chocolatey](https://chocolatey.org/) oder [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/) installiert werden.
...
Alle Binärdateien für Linux, macOS und Windows können von der [Release-Seite](https://github.com/cinesim/videodown/releases/latest) heruntergeladen werden. Falls keine Version für dein System verfügbar ist, öffne bitte ein [Issue](https://github.com/cinesim/videodown/issues).

## Entwicklung

Wenn du videodown selbst erstellen möchtest, sieh dir bitte unsere [Build-Anleitung](../dev/BUILD.md) an.

- [Benutzerdokumentation](../README.md)
- [Entwicklerdokumentation](../dev/README.md)

Bei Fragen zu videodown kannst du gerne ein Issue erstellen. Bitte verwende dabei das Standardformat. Natürlich ist auch ein direkter PR sehr willkommen.

## Beitrag

videodown befindet sich in der Entwicklung. Bitte lies den [Beitragsleitfaden](../../.github/CONTRIBUTING.md) vor dem Erstellen eines Pull Requests. Möchtest du Funktionen zu videodown hinzufügen? Sieh dir unsere [Roadmap](https://github.com/cinesim/videodown/projects) und offene Issues an.

## Mitwirkende

Danke an alle, die bereits zu videodown beigetragen haben[[Mitwirkende](https://github.com/cinesim/videodown/graphs/contributors)].
