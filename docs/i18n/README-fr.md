...
<h2 align="center">Soutenir videodown</h2>

videodown est un éditeur Markdown open-source soutenu par sa communauté. Si videodown améliore votre flux de travail, pensez à [soutenir le projet](https://github.com/sponsors/videodown). Merci à tous les sponsors ❤️

**Sponsor Spécial**

| [<img src="../assets/sponsors/serpapi.png" width="150">](https://serpapi.com/?utm_source=videodown) | [Extrayez les résultats de Google et d'autres moteurs de recherche grâce à notre API rapide, facile et complète.](https://serpapi.com/?utm_source=videodown) |
| --------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
Vous pouvez télécharger le dernier `videodown-%version%.dmg` depuis la [page de releases](https://github.com/cinesim/videodown/releases/latest) ou installer videodown via [**homebrew cask**](https://github.com/caskroom/homebrew-cask). Pour utiliser Homebrew-Cask, il vous suffit d'avoir [Homebrew](https://brew.sh/) installé.
...
Téléchargez et installez simplement videodown via l'assistant d'installation (`videodown-setup-%version%.exe`) et choisissez entre une installation par utilisateur ou pour tout le système. Vous pouvez aussi installer videodown via un gestionnaire de paquets comme [Chocolatey](https://chocolatey.org/) ou [Winget](https://docs.microsoft.com/en-us/windows/package-manager/winget/).
...
Tous les binaires pour Linux, macOS et Windows peuvent être téléchargés depuis la [page de releases](https://github.com/cinesim/videodown/releases/latest). Si une version n'est pas disponible pour votre système, veuillez ouvrir un [issue](https://github.com/cinesim/videodown/issues).

## Développement

Si vous souhaitez compiler videodown vous-même, consultez nos [instructions de compilation](../dev/BUILD.md).

- [Documentation utilisateur](../README.md)
- [Documentation développeur](../dev/README.md)

Si vous avez des questions concernant videodown, n'hésitez pas à ouvrir un issue. Lors de la création, veuillez utiliser le format par défaut. Bien sûr, si vous soumettez directement un PR, ce sera très apprécié.

## Contribution

videodown est en développement. Veuillez lire le [Guide de Contribution](../../.github/CONTRIBUTING.md) avant de faire un pull request. Vous souhaitez ajouter des fonctionnalités à videodown ? Consultez notre [feuille de route](https://github.com/cinesim/videodown/projects) et les issues ouvertes.

## Contributeurs

Merci à toutes les personnes qui ont déjà contribué à videodown[[contributeurs](https://github.com/cinesim/videodown/graphs/contributors)].
