...
describe('Native theme source', () => {
  ...
  it('uses dark native menus for dark videodown themes', () => {
  ...
  it('uses the shared videodown dark theme classification', () => {
  ...
  it('uses light native menus for light videodown themes', () => {
