...
process.env.VIDEODOWN_VERSION = VIDEODOWN_VERSION
process.env.VIDEODOWN_VERSION_STRING = VIDEODOWN_VERSION_STRING
...
electronApp.setAppUserModelId('com.electron.videodown')
