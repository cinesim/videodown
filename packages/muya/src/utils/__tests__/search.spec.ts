...
// Defensive coverage for the search helpers migrated from videodown.
//
// `buildRegexValue` already lines up with videodown 4c517b16 ("fix: search
...
describe('buildRegexValue — videodown 4c517b16 group expansion', () => {
