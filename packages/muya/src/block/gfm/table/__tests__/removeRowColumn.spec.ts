...
// Regression for videodown commit 6293d408 "fix: #572 — cursor placement
// after row/column delete". In videodown's `tableBlockCtrl`, when the user
...
// caret evaporated. videodown's fix routed through `findNextBlockInLocation`,
...
// destructive table edit" contract videodown had.
//
...
function makeFakeTable(rowCount: number, cellCount: number) {
    ...
    return {
        ...
        remove: vi.fn(),
        // The whole-table-removed branch (videodown 6293d408 cover-the-edge
...
describe('table.removeRow — returns surviving cell content for cursor placement (videodown 6293d408)', () => {
...
describe('table.removeColumn — returns surviving cell content for cursor placement (videodown 6293d408)', () => {
